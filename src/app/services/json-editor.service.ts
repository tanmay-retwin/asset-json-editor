...
export class JsonEditorService {
  private jsonDataSignal = signal<any>({
    sections: {
      overview: {
        da_power_rating_limit_xjkskldjflksjf: {
          ...
          datatype: 'percentage',
          required: false,
          field_name: 'da_power_rating_limit_name',
          description: 'da_power_rating_limit_desc',
        },
        zip: {
          units: 'units_text',
          default: '10115',
    ...
    translations: {
      en: {
        ...
        asset_initial_soc_desc: 'Initial state of charge at start of analysis',
        ...
        model_idc_half_hourly_energy_desc: 'ID market with 1/2 hour contracts',
        ...
        asset_total_cycles_over_lifetime_desc: 'Total Cycles over the lifetime',
  ...
  public jsonData = computed(() => this.jsonDataSignal());
  ...
  addField(
    ...
    this.jsonDataSignal.set({ ...currentData });
  }
